# Generated by Powerlevel10k configuration wizard on 2023-03-21 at 09:23 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=#5B6078
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%05F'   # green foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=005
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=#5B6078  # Duration format: 1d 2h 3m 4s.
  ...
  #######################[ go_version: go version (https://golang.org) ]########################
  # Go version color.
  typeset -g POWERLEVEL9K_GO_VERSION_FOREGROUND=111
